...
const PAGE_NAMES = { home: 'Home', vocabulary: 'Vocabolario', grammar: 'Grammatica', reading: 'Lettura', quiz: 'Quiz', verbs: 'Verbi', 'special-verbs': 'Verbi Speciali', practice: 'Pratica', favorites: 'Salvate', lessons: 'Lezioni' };
